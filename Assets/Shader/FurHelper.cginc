...
v2f vert_surface(appdata_base v)
{
    ...
    o.uvSkin = TRANSFORM_TEX(v.texcoord, _SkinTex);
...
fixed4 frag_surface(v2f i): SV_Target
{
    ...
    fixed4 skin = tex2D(_SkinTex, i.uvSkin);

    fixed3 albedo = (1 - skin.a) * tex2D(_MainTex, i.uv.xy).rgb * _Color + skin.a * skin.rgb;
...
fixed4 frag_base(v2f i): SV_Target
{
    ...
    fixed4 skin = tex2D(_SkinTex, i.uv.zw);
    fixed alpha = clamp(noise - (FURSTEP * FURSTEP) * _FurDensity - skin.a, 0, 1);
